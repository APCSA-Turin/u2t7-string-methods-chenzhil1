package U2T7_P3_MethodUsingStringMethod;
    ...
    */
    public String endUp(String myString, int numToCap){
        if(numToCap > myString.length()) {
            numToCap = myString.length();
        }

        String upper = myString.substring(myString.length() - numToCap).toUpperCase();
        myString = myString.substring(0, myString.length() - numToCap) + upper;
        return myString;
    }
    ...
    */
    ...
    public String starBetween(String myString) {
        ...
        while(index < myString.length() - 1) {
            editString += myString.substring(index, index + 1);
            editString += "*";
            index += 1;
        }

        editString += myString.substring(myString.length() - 1);
        return editString;
    }
  }
